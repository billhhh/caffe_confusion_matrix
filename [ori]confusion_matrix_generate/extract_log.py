...
util_file_root = 'C:\\Users\\hengzhao\\Desktop\\Foodai_ZH\\deployed_api_foodai_org\\confusion_matrix_analysis\\zh_model_food724_baseline'
...
# READ LABEL DICT
label_file = os.path.join(util_file_root,'labels.txt')
label_dict = {}
